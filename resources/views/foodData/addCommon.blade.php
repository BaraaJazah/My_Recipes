    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card  box-shadow-0">
            <div class="card-header">
                <h4 class="card-title mb-1">Add Common Names For Food</h4>
            </div>
            <div class="card-body pt-0">
                <form method="POST" action ="{{route('addCommons')}}" class="form-horizontal">
                    @method('POST')
                    @csrf 
                        ...
                        <div class="form-group">
                            <p>Add Common Name</p>                        
                                ...
                                <tr>  
                                <td><input type="text" name="name[]" placeholder="Enter Common Name" class="form-control name_list"  id="title"></td>  
                                <td><button type="button" name="add" id="add" class="btn btn-success">Add Common Name</button></td>  
                                </tr>  
                                </table>  
                            <br>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table mg-b-0 text-md-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr class="Bcount">
                                <th></th>
                                <td>{{$item->name}} Common Names</td>
                                <td>
                                    @if ($item->id )
                                        <a href="{{route('deleteCommon' , $item->id)}}" class="btn btn-sm btn-danger">
...
var title = $("#title").val();
i++;  
$('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="name[]" placeholder="Enter Common Name" class="form-control name_list" value="'+title+'" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
});  
