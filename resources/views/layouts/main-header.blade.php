			...
			<div class="main-header sticky side-header nav nav-item">
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<form action="{{route("searchFood")}}" method="GET">
							<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
								<input name="name" class="form-control" placeholder="Search for anything ..." >
					...
					<div class="main-header-right">
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="nav-item" style="padding-left : 20px ;  ">
								<a  href="{{route('add_food')}}" style = "font-size : 13px" class="btn btn-outline-secondary btn-rounded btn-block">Add Food</a>
							</div>
